...
public class IdCardUtil {
	...
	private static Logger logger = LogManager.getLogger(IdCardUtil.class);
	 ...
	 * "130321860311519"; String idcard18 = "210102198617083732";// String
	 * idcard="610**************"; //自己身份证测试
	 * System.out.println(isValidatedAllIdcard(idcard)); // 15位身份证
