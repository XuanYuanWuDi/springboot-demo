package com.injured.framework.manager.factory;

import java.util.TimerTask;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import com.injured.common.constant.Constants;
import com.injured.common.utils.AddressUtils;
import com.injured.common.utils.LogUtils;
...
import com.injured.project.monitor.logininfor.domain.Logininfor;
import com.injured.project.monitor.logininfor.service.LogininforServiceImpl;
import com.injured.project.monitor.online.domain.OnlineSession;
import com.injured.project.monitor.online.domain.UserOnline;
import com.injured.project.monitor.online.service.IUserOnlineService;
...
public class AsyncFactory
{
    ...
    public static TimerTask syncSessionToDb(final OnlineSession session)
    {
        return new TimerTask()
        {
            ...
            public void run()
            {
                ...
                online.setDeptName(session.getUserId().toString());
     ...
     * @return 任务task
     */
    public static TimerTask useIsMoveIn(Integer isMoveIn, Long userId, String loginName)
    {
        return new TimerTask()
        {
            @Override
            public void run()
            {
                ...
                SpringUtils.getBean(IUserService.class).updateUserInfo(user);
            }
        };
    }
}
