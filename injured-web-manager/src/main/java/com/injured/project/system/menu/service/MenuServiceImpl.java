package com.injured.project.system.menu.service;
...
import com.injured.common.utils.TreeUtils;
...
public class MenuServiceImpl implements IMenuService
{
     ...
     */
    @Override
    public List<Menu> selectMenuByRemark(String remark)
    {
    	List<Menu> menuList = menuMapper.selectMenuByRemark(remark);
        return menuList;
    }
     ...
     */
    @Override
    public List<Menu> selectPermissionsMenu(String remark)
    {
    	List<Menu> menuList = menuMapper.selectPermissionsMenu(remark);
        return menuList;
    }
}
