 ...
 * @author 
 */
public class InjuredEstimatedLoss implements Serializable {
    /**
     * 主键
     */
    private Long id;
     ...
     * 估损类型 1常规 2调解
     */
    private Byte estimatType;

    /**
     * 估损类型二级 1现场 2非现场
     */
    private Byte estimatSecondType;
    ...
    public Byte getEstimatType() {
        return estimatType;
    }

    public void setEstimatType(Byte estimatType) {
        this.estimatType = estimatType;
    }

    public Byte getEstimatSecondType() {
        return estimatSecondType;
    }

    public void setEstimatSecondType(Byte estimatSecondType) {
        this.estimatSecondType = estimatSecondType;
    }
